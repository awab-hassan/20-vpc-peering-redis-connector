...
locals {
  vpc_id     = "vpc-0ad8d1965c1fba7c7"
  subnet_id  = "subnet-0c3a3a85f9e3c904d"
  environment = "staging"
  redis_host = "redis-cluster.s3psra.0001.apne1.cache.amazonaws.com"
  redis_port = "6379"
  origin_host = "10.50.10.199"
